class Juego {
  constructor() {
    ...
    this.botonCreditos = new Boton(width / 2 - 75, height / 2 + 70, 150, 40, "Créditos", () => {
  ...
  mostrarHUD() {
    fill(0);
    textSize(16);
    text(`Vidas: ${this.personaje.vidas}`, 10, 20);
    text(`Puntos: ${this.personaje.puntos}`, 10, 40);
  ...
  mostrarFinDelJuego() {
    ...
    if (this.personaje.vidas <= 0) {
      ...
      textSize(24)
      text("Puntos: " + this.personaje.puntos, width / 2, height / 2 + 40);
    } else {
